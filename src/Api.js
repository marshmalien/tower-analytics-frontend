...
const jobExplorerEndpoint = `/api/tower-analytics/${apiVersionNext}/job_explorer/`;
const jobExplorerOptionsEndpoint = `/api/tower-analytics/${apiVersionNext}/job_explorer_options/`;
